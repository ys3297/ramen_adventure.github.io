...
The total number of brands is `r nrow(count(tidy_ramen, brand))`. The number of brands with 5-Stars ramens is `r nrow(count(five_stars, brand))`, and the number of brands with 0-Stars ramens is `r nrow(count(zero_stars, brand))`. 
