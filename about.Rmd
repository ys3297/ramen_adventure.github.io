...
### Methods
We conducted data cleaning on the raw dataset, which includes: separating the variable "top_ten" into two columns ("year" and "rank"); combining Taiwan, Hong Kong, and China as one variable (Taiwan and Hong Kong are regions of China, but not individual countries); and setting variables to the appropriate data type.
