...
Then, let's take a look at the distribtion of ramen rating by packaging style. 
```{r, echo=FALSE, message=FALSE, warning=FALSE}
four_styles = 
  tidy_ramen %>%
...
From the violin graph, we can see that the residual distribution by styles is generally left-skewed, indicating failures in model assumptions.