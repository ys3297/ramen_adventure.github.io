...
num_five_various = 
  ...
  mutate(prct = num_five / num_varieties)
...
prct_plot = 
  ...
  labs(
    title = "Percentage of 5 Stars Ramen among the 5 Most Various Brands",
    x = "Brand Name",
...
All of these 5 brands have at least one ramen was rated as `5 Stars`. *Paldo* has the highest percentage of ramen rated as `5 Stars`, while *Maruchan* has the lowest percentage of ramen rated as `5 Stars`.

## Conclusion

There are 355 ramen brands in this dataset. *Nissin*, *Nongshim*, *Maruchan*, *Mama*, and *Paldo* are the 5 brands the largest number of varieties. The median of these 5 brands are higher than `3 Stars`. *Paldo* has the highest percentage of ramen rated as `5 Stars`.
